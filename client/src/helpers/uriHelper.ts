const address = import.meta.env.VITE_ANALYTICS_SERVER_HOST || window.location.hostname
const isSecure = import.meta.env.VITE_ANALYTICS_SERVER_HTTPS || window.location.protocol === 'https:'
